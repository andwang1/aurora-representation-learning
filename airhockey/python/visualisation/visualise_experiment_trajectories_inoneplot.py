...
FULL_PATH = "/media/andwang1/SAMSUNG/MSC_INDIV/results_box2d_imagesd_exp1/l0nosampletrain/results_imagesd_vae/gen6001_random1_fulllossfalse_beta1_extension0_lossfunc0_sigmoidfalse_samplefalse_tsne0"
...
for i, dir in enumerate(PIDs):
    ...
    for idx, indiv in enumerate(plotting_data):
        ...
        # Plot
        axes[i].plot(x_label, y_label, color="gray", alpha=0.05)
